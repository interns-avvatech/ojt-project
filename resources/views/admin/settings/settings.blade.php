...
<div class="col-lg-12">
    <div class="d-flex justify-content-between">
        ...
        <div class="mt-3">
            <button class="btn btn-small btn-secondary" type="button" data-toggle="modal" data-target="#addMethod">User Management</button>
            <button class="btn btn-small btn-secondary" type="button" data-toggle="modal" data-target="#addMethod">User Role</button>
            <button class="btn btn-small btn-secondary" type="button" data-toggle="modal" data-target="#addMethod">Payment Settings</button>
        </div>
    </div>
</div>
...
<div class="mt-0 col-12">
    ...
    <div class="d-flex justify-content-between">
        <h5><b>Currency</b></h5>
        <button class="btn btn-small btn-secondary" type="button" data-toggle="modal" data-target="#addCurrency">Add Currency</button>
    </div>
    ...
    <div class="row align-items-start">
        <div class="col-sm">
            ...
            <select name="tcg_low" class="form-control">
                @foreach ($settings['currency_option'] as $settingCurrency)
                <option value="{{ $settingCurrency['id'] }}" @if ($settings['tcg_low']===$settingCurrency['id']) selected @endif>
                    {{ $settingCurrency['symbol'] }}
                </option>
                @endforeach
            </select>
