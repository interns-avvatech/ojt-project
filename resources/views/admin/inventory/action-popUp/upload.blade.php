            ...
            <div class="modal-body">
                <div class="">
                    <form action="{{ route('importProductFromCsv') }}" class="row justify-content-center"
                        ...
                        <button type="submit" id="submit" class="btn btn-success col-2 w-auto disable ms-2">Import CSV</button>
                        <button id="loading" class="btn btn-success col-2 w-auto ms-2" hidden type="button" disabled>
